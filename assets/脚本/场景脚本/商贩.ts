...
const 黑市列表: 商贩项目类型[] = [
  ...
  {
    名称: () => `出售黑曜石（0.5元/个，已有${存档.物品.黑曜石}个）`,
    条件: () => 存档.天赋.市井通途 >= 2,
    购买: () => {
      if (存档.物品.黑曜石 <= 0) {
        return '你身上没有黑曜石。';
      ...
      存档.物品.黑曜石 -= 1;
      存档.金钱 += 5;
      return '出售「黑曜石」*1，获得0.5元！';
    },
  },
  {
    名称: () => `购买火狐皮（1元/张，已有${存档.物品.火狐皮}张）`,
    条件: () => 存档.天赋.市井通途 >= 2,
    购买: () => {
      if (存档.金钱 < 10) {
        return '钱不够！';
  ...
  {
    名称: () => `出售火狐皮（0.5元/张，已有${存档.物品.火狐皮}张）`,
    条件: () => 存档.天赋.市井通途 >= 2,
    购买: () => {
      if (存档.物品.火狐皮 <= 0) {
        return '你身上没有火狐皮。';
