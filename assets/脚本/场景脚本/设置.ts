...
export class 设置 extends Component {
  ...
  速度表 = { 1: '一般', 2: '快速', 5: '极速' };
  start() {
    this.出场语输入框.getComponent(EditBox).string = 玩家.客户端数据?.出场语 || '';
    this.战胜语输入框.getComponent(EditBox).string = 玩家.客户端数据?.战胜语 || '';
    this.战败语输入框.getComponent(EditBox).string = 玩家.客户端数据?.战败语 || '';
  ...
  点击确认() {
    玩家.客户端数据.出场语 = this.出场语输入框.getComponent(EditBox).string || '';
    玩家.客户端数据.战胜语 = this.战胜语输入框.getComponent(EditBox).string || '';
