...
export class 住房 extends Component {
    ...
    生成数据() {
        const 中介列表 = [
            ...
            { 等级: 1, 名称: "陈哥", 数量: [10, 12], 住房: [0, 5], 品质: [0, 2], 价格倍率: 1.25, 出现概率: 30, 介绍: "我房源路子广，高中低档都有，价格公道噢~" },
            { 等级: 2, 名称: "林姐", 数量: [7, 9], 住房: [1, 5], 品质: [0, 2], 价格倍率: 1.4, 出现概率: 30, 介绍: "我只做干净靠谱的正规房源，环境卫生都过关，住着舒心，价格自然不会太便宜的~" },
