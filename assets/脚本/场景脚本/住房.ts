...
export class 住房 extends Component {
    ...
    生成数据() {
        const 中介列表 = [
            ...
            { 等级: 2, 名称: "林姐", 数量: [7, 9], 住房: [1, 6], 品质: [0, 2], 价格倍率: 1.4, 出现概率: 30, 介绍: "我只做干净靠谱的正规房源，环境卫生都过关，住着舒心，价格自然不会太便宜哦~" },
            { 等级: 3, 名称: "吴经理", 数量: [9, 11], 住房: [3, 7], 品质: [1, 3], 价格倍率: 1.6, 出现概率: 2, 介绍: "我负责小区优质精装房源，管理规范、配套齐全，只做高品质长租~" }
        ];
    ...
    刷新属性() {
        ...
        this.属性二.getComponent(Label).string = `当前住房信息\n【多人宿舍】\n已居住1/10天`
    }
    ...
    显示房源() {
        ...
        选项3.on(Button.EventType.CLICK, () => this.点击购买(30), this)
        选项2.on(Button.EventType.CLICK, () => this.点击购买(7), this)
        选项1.on(Button.EventType.CLICK, () => this.点击购买(3), this)
    }

    点击购买(day: number) {
        播放文本(this.标签, '点击购买' + day)
        this.刷新属性()
    }
}