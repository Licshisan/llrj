  ...
  渲染面板列表() {
    ...
    if(对象求和(存档.临时数据.残页) > 0){
      for(let 残页 in 存档.临时数据.残页){
        const 残页表 = {
          青竹步残页: { 名称: "青竹步", 门派: "青竹门", 效果: ["受击减伤触发率小幅提高", "受击减伤触发率小幅提高", "受击减伤触发率小幅提高", "受击减伤触发率小幅提高"]},
          铁衣功残页: { 名称: "铁衣功", 门派: "铁衣帮", 效果: ["防御+2%，最大生命+5%", "防御+2%，最大生命+5%", "防御+2%，最大生命+5%", "防御+2%，最大生命+5%"]},
          玄水诀残页: { 名称: "玄水诀", 门派: "玄水阁", 效果: ["生命恢复+1%", "生命恢复+1%", "生命恢复+1%", "生命恢复+1%"]},
        }
