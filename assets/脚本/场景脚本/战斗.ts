...
export class 战斗 extends Component {
    ...
    进入战斗(敌人名称: string) {
        ...
        if (this.敌人.特殊) {
            if (存档.特殊敌人[敌人名称].生命) {
                this.敌人.等级 = 存档.特殊敌人[敌人名称].等级
                this.敌人.生命 = 存档.特殊敌人[敌人名称].生命
                this.敌人.最大生命 = 存档.特殊敌人[敌人名称].最大生命
                this.敌人.攻击 = 存档.特殊敌人[敌人名称].攻击
                this.敌人.防御 = 存档.特殊敌人[敌人名称].防御
            } else {
                存档.特殊敌人[敌人名称] = {
                    等级: this.敌人.等级,
                    生命: this.敌人.生命,
        ...
        if (this.敌人.生命 <= 0 || this.敌人.生命 > this.敌人.最大生命) {
            this.敌人.生命 = 存档.特殊敌人[敌人名称].最大生命
        }
